            ...
            <div className='row'>
                <div className='col-sm-7'>
                    <div className="card bg-light mx-auto">
                        <div className="card-title text-center"><h3><strong><i>{this.props.location.state.code}</i>: {this.props.location.state.name}</strong></h3></div>
                    </div>
                    <hr />
                    <h2>
                ...
                <div className='col-sm-5'>
                    <div className='card bg-light mx-auto'>
                        <div className='card-body align-left '>
                            {this.state.show ? click : <button type="button" className="btn btn-dark w-20 mx-1" onClick={this.showForm}>Add Assignment</button>}
                            {this.state.show ? null : <button className="btn w-20 mx-1"><Link className='text-dark' to="/courses"> Back To Courses </Link></button>}
