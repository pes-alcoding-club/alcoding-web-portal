...
const Footer = () => (
  <footer className="footer">
    ...
    <div className="lead text-center pt-2">We'd love your help! Click <Link className="text-light font-italic" to="/contribute">here</Link> to contribute to this project.</div>
